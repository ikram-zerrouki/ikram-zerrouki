...
| Project | Description |
|--------|-------------|
| **Medical Data Prediction** | Post-surgery complication predictor for cardiac patients using Random Forest + LLMs (Gemma 2, Phi-2). Real data from CHU Mustapha. |
| **Parkinson Diagnosis Platform** | ML-based diagnostic tool using CNN (ResNet, MobileNet), wrapped in a React + Django batch web app for healthcare professionals. |
| **Smart ERP Modules (Odoo v17)** | Customized modules for quality control, production & sales – adapted to real industrial workflows. |
| **Well Operations Dashboard** | Oil drilling monitoring system with real-time anomaly detection based on cost & delay thresholds from daily reports. |
| **Financial Analysis App** | PyQt5 desktop tool that reads Excel balance sheets, calculates ratios, and generates visual reports across 3 years. |
